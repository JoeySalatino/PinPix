    ...
    <View style={styles.root}>
      ...
      <SafeAreaView style={styles.topBar}>
        <View style={styles.topBarInner}>
          ...
          {/* Profile button */}
          <TouchableOpacity style={styles.iconButton} onPress={() => router.push('/screens/ProfileScreen')}>
            <Ionicons name="person-outline" size={22} color={NAVY} />
          </TouchableOpacity>

          {/* Settings button */}
          <TouchableOpacity style={[styles.iconButton, { marginLeft: 8 }]} onPress={() => router.push('/screens/SettingsScreen')}>
      ...
      <TouchableOpacity
        style={styles.fab}
        onPress={() => router.push('/screens/AddSpotScreen')}
        activeOpacity={0.85}
      >
